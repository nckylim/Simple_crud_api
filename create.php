      ...
      <center>
        <table style="width: 80%;">
          <tr>
            ...
            <td width="50%"><input type="text" name="f_name" value="" required></td>
          </tr>

          <tr>
            <td><label>Last Name</label></td>
            <td><input type="text" name="l_name" value="" required></td>
          </tr>
          ...
          <tr>
            ...
            <td><input type="password" name="n_pass" value="" minlength="8" required></td>
          </tr>

          <tr>
            <td><label>Confirm Password</label></td>
            <td><input type="password" name="c_pass" value="" minlength="8" required></td>
          </tr>
